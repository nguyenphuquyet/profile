...
function show_date_time() {
    ...
    BirthDay = new Date("2024/02/5");           /*Chỉnh sửa ngày tạo web*/
    today = new Date();
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/quyetdz.19', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Instagram');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.instagram.com/quyetdz2010', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Tiktok');
    telegramDiv.addEventListener('click', function () {
        window.open('https://tiktok.com/@quyet_dev', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Youtube');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.youtube.com/@quyetdev.14', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Zalo');
    telegramDiv.addEventListener('click', function () {
        window.open('https://zalo.me/0343018765', '_blank');
    });
});
...
console.log('%c- Có vẻ như bạn đang cố tình ăn cắp mã nguồn của tôi </ Nguyễn Phú Quyết >.', 'color: #444; font-size: 25px; font-family: sans-serif;');
...
welcomeText.textContent = "Nguyễn Phú Quyết";
...
continueText.textContent = "=>> Xin chào bạn <<=";
